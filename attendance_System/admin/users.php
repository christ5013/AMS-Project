				...
				<table id="table" class="table table-bordered table-striped">
					...
					?>	
						<tr>
							...
							<td>
								<center>
								 <button class="btn btn-sm btn-outline-primary edit_user" data-id="<?php echo $row['username']?>" type="button"><i class="fa fa-edit"></i></button>
								<button class="btn btn-sm btn-outline-danger remove_user" data-id="<?php echo $row['username']?>" type="button"><i class="fa fa-trash"></i></button>
								</center>
							</td>
						</tr>
					<?php
			...
			<div class="modal fade" id="manage_user" tabindex="-1" role="dialog" aria-labelledby="manage_userlabel">
				<div class="modal-dialog" role="document">
					<div class="modal-content panel-primary">
						<div class="modal-header panel-heading text-white" style = "background:linear-gradient(to bottom, #33cccc 0%, #336699 100%);">
							<h4 class="modal-title"></h4>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						</div>
						<form id="user-frm" style = "background-color:beige;">
							<div class ="modal-body">
								<input type="hidden" name='id'>
								<div class="form-group">
									<label>Username:</label>
									<input type="text" name="username" class="form-control rounded bg-white text-dark" id="employee_no" style = "border-top: 1px solid gray; border-right: 1px solid gray; border-left: 1px solid gray;" />
								</div>
								<div class="form-group">
									<label>Password:</label>
									<input type="password" maxlength="20" required="required" name="password" class="form-control rounded bg-white text-dark" style = "border-top: 1px solid gray; border-right: 1px solid gray; border-left: 1px solid gray;" />
								</div>
								<div class="form-group">
									<label>Firstname:</label>
									<input type="text" name="firstname" required class="form-control rounded bg-white text-dark" style = "border-top: 1px solid gray; border-right: 1px solid gray; border-left: 1px solid gray;"/>
								</div>
								<div class="form-group">
